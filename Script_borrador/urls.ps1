...
$Revisar_alertas_activas = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#monitoreo-de-alertas"
)
...
$Monitoreo_de_Incidentes = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#monitoreo-de-incidentes"
)
...
$Triage_de_Mensajes_de_Teams_Reportados_por_Usuarios = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#triage-de-mensajes-de-teams-reportados-por-usuarios"
)
...
$Revisar_y_Actuar_sobre_los_AIRs = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#revisar-y-actuar-sobre-los-airs"
)
...
$Revisar_las_Tendencias_de_Detección_de_Correo_en_Microsoft_Defender_for_Office_365 = @(    
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#revisar-las-tendencias-de-detección-de-correo-en-microsoft-defender-for-office-365"
)
...
$Revisar_Campañas_de_Phishing_y_Malware_que_Resultaron_en_Correos_Entregados = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#revisar-campa%C3%B1as-de-phishing-y-malware-que-resultaron-en-correos-entregados"
)
...
$Revisión_de_Top_Targeted_Users = @(
    "https://security.microsoft.com/threatexplorerv3",
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/01%20Guia%20de%20Seguridad%20Operacional%20MDO%20tareas%20diarias.md#revisi%C3%B3n-de-top-targeted-users"
)
...
$Revisar_Tendencias_de_Detección_de_Correo_en_Microsoft_Defender_for_Office_365 = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/02%20Guia%20de%20Seguridad%20Operacional%20MDO%20Semanal.md#revisar-tendencias-de-detecci%C3%B3n-de-correo-en-microsoft-defender-for-office-365"
)
...
$Identificar_Usuarios_Más_Atacados_por_Malware_y_Phishing = @(
    "https://security.microsoft.com/emailandcollabreport",
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/02%20Guia%20de%20Seguridad%20Operacional%20MDO%20Semanal.md#identificar-usuarios-m%C3%A1s-atacados-por-malware-y-phishing"
)
...
$Revisar_Campañas_de_Malware_y_Phishing = @(
    "https://security.microsoft.com/threatexplorerv3",
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDO/02%20Guia%20de%20Seguridad%20Operacional%20MDO%20Semanal.md#revisar-campa%C3%B1as-de-malware-y-phishing-campaigns--mdo-p2"
)
...
$Revisar_ITDR_Dashboard = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20diaria%20de%20Microsoft%20Defender%20for%20Identity.md#revisar-itdr-dashboard-identities--dashboard"
)
...
$Triage_de_Incidentes_por_Prioridad = @(
    "https://security.microsoft.com/incidents",
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20diaria%20de%20Microsoft%20Defender%20for%20Identity.md#triage-de-incidentes-por-prioridad-incidents--alerts"
)
...
$Configurar_Tuning_para_Benign_False_Positives = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20diaria%20de%20Microsoft%20Defender%20for%20Identity.md#configurar-tuning-para-benign--false-positives-advanced-hunting"
    )
...
$Proactive_hunting_diario_o_semanal = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20diaria%20de%20Microsoft%20Defender%20for%20Identity.md#proactive-hunting-diario-o-semanal-seg%C3%BAn-madurez"
)
...
$Revisar_Health_Issues_Global_y_Sensor = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20diaria%20de%20Microsoft%20Defender%20for%20Identity.md#revisar-health-issues-global-y-sensor"
)
...
$Revisar_recomendaciones_de_Secure_Score = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20semanal%20de%20Microsoft%20Defender%20for%20Identity.md#revisar-recomendaciones-de-secure-score-por-producto"
)
...
$Revisar_y_responder_a_amenazas_emergentes = @(
    "https://security.microsoft.com/advanced-hunting",
    "https://github.com/watchdogcode/gol2026/blob/V2.1/MDI/Gu%C3%ADa%20operativa%20semanal%20de%20Microsoft%20Defender%20for%20Identity.md#revisar-y-responder-a-amenazas-emergentes-custom-detections"
)
...
$Monitorear_eventos_de_inicio_de_sesión_y_autenticación = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20Microsoft%20EntraID%20Diaria.md#monitorear-eventos-de-inicio-de-sesi%C3%B3n-y-autenticaci%C3%B3n"
)
...
$Revisión_de_Usuarios_con_Riesgo_Alto_Medio = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20Microsoft%20EntraID%20Diaria.md#revisi%C3%B3n-de-usuarios-con-riesgo-alto--medio"
)
...
$Revisión_de_Inicios_de_Sesión_con_Riesgo = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20Microsoft%20EntraID%20Diaria.md#revisi%C3%B3n-de-inicios-de-sesi%C3%B3n-con-riesgo"
)
...
$Revisar_alertas_de_Microsoft_Entra_Connect_Health = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20Microsoft%20EntraID%20Diaria.md#revisar-alertas-de-microsoft-entra-connect-health-entornos-h%C3%ADbridos"
)
...
$Revisión_de_cambios_administrativos = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20EntraID%20Tareas%20Semanales.md#revisi%C3%B3n-de-cambios-administrativos"
)
...
$Seguimiento_del_Identity_Secure_Score = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20EntraID%20Tareas%20Semanales.md#seguimiento-del-identity-secure-score"
)
...
$Revisión_de_errores_de_sincronización_antiguos = @(
    ...
    "https://github.com/watchdogcode/gol2026/blob/V2.1/EntraID/Gu%C3%ADa%20Operacional%20EntraID%20Tareas%20Semanales.md#revisi%C3%B3n-de-errores-de-sincronizaci%C3%B3n-antiguos"
)
