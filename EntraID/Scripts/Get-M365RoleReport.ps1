...
"@
	...
	$htmlBody = @"
<h1>Reporte de Asignación de Roles Administrativos - Microsoft 365 <em style="font-size: 0.75em; font-weight: normal; margin-left: 80px;">&ldquo;La tecnología permite la seguridad, pero es la disciplina la que garantiza su efectividad&rdquo;</em></h1>
