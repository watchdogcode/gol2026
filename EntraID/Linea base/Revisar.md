...
- Con qué frecuencia desea revisar las asignaciones de roles (pueden existir diferentes intervalos según el rol).
...
Existe un script de ejemplo disponible que enumera los usuarios asignados a roles en:
